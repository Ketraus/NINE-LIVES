...
export default class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    // Paws ("fists"): agora tem idle e walk próprios.
    this.load.spritesheet('player_paws_walk', 'assets/sprites/player_paws_walk.png', {
      frameWidth: 64,
      frameHeight: 64
    });
    this.load.spritesheet('player_paws_idle', 'assets/sprites/player_paws_idle.png', {
      frameWidth: 64,
      frameHeight: 64
    });
    ...
    // CyberHound (Runner): mesmo padrão
    this.load.image('cyber_hound_idle', 'assets/sprites/cyber_hound_idle.png');
    this.load.spritesheet('cyber_hound_walk', 'assets/sprites/cyber_hound_walk.png', {
      frameWidth: 64,
      frameHeight: 64
    });
    ...
    // Exploder: mesmo padrão
    this.load.image('exploder_idle', 'assets/sprites/exploder_idle.png');
    this.load.spritesheet('exploder_walk', 'assets/sprites/exploder_walk.png', {
      frameWidth: 64,
      frameHeight: 64
    });
    // Elite: mesmo padrão
  ...
  create() {
    ...
    // animação de andar do CyberHound — frameRate mais alto que o Grunt
    // (16 vs 12) pra combinar com a velocidade dele (speed 120 vs 60 no
    // enemies.js, o dobro), pernas visivelmente mais rápidas
    this.anims.create({
    ...
    // animação de andar do Exploder — mesma lógica proporcional (speed 45
    // vs 60 do Grunt)
    this.anims.create({
      key: 'exploder-walk',
